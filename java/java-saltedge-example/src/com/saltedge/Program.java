...
public class Program {
    ...
    public static void main (String[] arg) {
    	System.out.println(new SaltEdge().get("https://www.saltedge.com/api/v3/countries"));
...
//
//        System.out.println(new SaltEdge().post("https://www.saltedge.com/api/v3/customers", jobject));
    }
}
